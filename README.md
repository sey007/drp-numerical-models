In this project we wish to solve $-\phi'' + 4 \phi = f$ on $[0,1]$ using three methods: finite difference, Pseudospectral, and Green's function, subject to Periodic Boundary Conditions (PBC). Additionally, we wish to verify empirically the orders of convergence against theory.
